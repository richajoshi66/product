    ...
    render(){
        return(
            ...
            <section class="price-details-section ">
                ...
                <div class="white-block-padd box-shadow">
                  ...
                  <div id="collapseTwo" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion2">
                    ...
                    <div class="row align-items-end">
                      <div class="col-md-8">
                        <div class="form-group">
                          <h2 class="section-heading mt-2 mb-3">Add another view of Product</h2>
             ...
             <section class="product-variant-section accordion"  id="accordion6">
               <div class="container">
                <div class="white-block-padd box-shadow">
                  <div class="d-flex inner-section-headings justify-content-between align-items-start  cz-accordian-bar">
                    <div class="checkbox-container-square checkbox-simple">
                      <input class="cz-check" type="checkbox" id="check3"/>
                      <label for="check3">
                        <h2>This product has multiple options, like different sizes or colors</h2>
                        <small>(Bulk upload product variants)</small>
                      </label>
                    </div>
                    <span class="d-inline-block pl-4" data-toggle="collapse" data-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix"><i class="fa fa-angle-up"></i></span>              
                  </div>
                  ...
                  <div id="collapseSix" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion6">
                      ...
                      <div class="row align-items-end form-row mb-3">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                          <div class="form-group">
                            <label>Select size, color, material, style, title.</label>
                            <select class="form-control" name="" id="">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                          <div class="form-group grey-box">
                            <span class="badge badge-secondary badge-rounded">Black <i class="fa fa-times-circle mr-1"></i></span>
                            <span class="badge badge-secondary badge-rounded">White <i class="fa fa-times-circle mr-1"></i></span>
                          </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                          <div class="form-group col-border-left">
                            <button type="button" class="btn btn-link text-danger pl-0 mr-3"><i class="fa fa-times mr-2"></i>REMOVE</button>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row align-items-end form-row mb-3">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                          <div class="form-group">
                            <label for="">Separate options by a comma</label>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                          <div class="form-group col-border-left">
                            <button type="button" class="btn btn-link text-danger pl-0 mr-3"><i class="fa fa-times mr-2"></i>REMOVE</button>
                            <button type="button" class="btn btn-dark"><i class="fa fa-plus mr-2"></i>Add More</button>
                          </div>
                        </div>
                      </div>
